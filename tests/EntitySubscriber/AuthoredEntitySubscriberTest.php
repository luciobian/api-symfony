...
use App\Entity\User;
use App\EventSuscriber\AuthoredEntitySuscriber;
...
class AuthoredEntitySubscriberTest extends TestCase
{
    ...
    {
        $result = AuthoredEntitySuscriber::getSubscribedEvents();
    ...
    public function testSetAuthorCall(string $className, bool $shouldCallSetAuthor, string $method)
    {
        ...
        (new AuthoredEntitySuscriber($tokenStorageMock))->getAuthenticatedUser(
            $eventMock
        );
    }
